# 31. Catalog 탐색 (Explore the Catalog)

**소요 시간:** 약 20분

## 학습 목표

Catalog를 탐색하여 데이터 자산에 대한 인사이트를 얻습니다.
...
- **(A) Search**: 전체 Catalog에서 데이터/Story 자산, Glossary Term, Data Products, KPI 자유 텍스트 검색
- **(B) Filter Panel**: 필터 옵션으로 검색 결과 범위 좁히기
...
**Impact and Lineage** 다이어그램으로 데이터 흐름 파악:
- 데이터 자산의 원본 소스까지 **Lineage(계보)** 추적
