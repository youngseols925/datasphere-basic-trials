...
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image00.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image42.png)

## 학습 목표
Google Cloud Storage에서 제품 감성 데이터를 읽는 Data Flow를 생성합니다.

![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image44.png)
...
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image02.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image03.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image04.png)

### 2단계: Data Flow 생성
1. **Data Builder**를 선택합니다.

![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image01.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image05.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image06.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image07.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image09.png)

2. **New Data Flow** 타일을 선택하여 편집기를 엽니다.
3. 소스로 **GCP_STORAGE**를 선택하고 파일 경로를 지정합니다.

![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image10.png)

### 3단계: Python 스크립트 추가
Data Flow에 Python 스크립트 노드를 추가하여 데이터를 변환합니다. 소셜 미디어 텍스트에서 감성 점수를 계산하는 로직을 작성합니다.

![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image11.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image12.png)

![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image14.png)

### 4단계: Projection 추가
필요한 컬럼만 선택하고 데이터 타입을 조정하는 Projection 노드를 추가합니다.

![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image13.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image15.png)
![화면](../images/510_DSP_Data_Acquisition_Images_510_3_image16.png)
